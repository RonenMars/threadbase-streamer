...
**Status (2026-07-22):** 🔄 In flight — [PR #240](https://github.com/RonenMars/threadbase-streamer/pull/240) requires `afterBootout: true` for exit-5 empty-stderr tolerance.
...
**Status (2026-07-22):** ♻️ Superseded on modern mobile (Favorites-only Quick Access, `type: conversation` routing). Legacy `/api/sessions/recents` retained for older clients — do not remove without a coordinated mobile minimum version.
