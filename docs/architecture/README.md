...
| 2026-07-27 | [sessions-ownership-path-filter](2026-07-27-sessions-ownership-path-filter.md) | Filter `GET /api/sessions` by `ownership` (streamer-managed) and `projectPath`. |
