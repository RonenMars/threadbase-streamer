...
Moved to its own document: [docs/runbooks/2026-07-22-land-open-prs.md](../runbooks/2026-07-22-land-open-prs.md).

It is an executable procedure with a lifetime of its own — it changes as PRs land, while this report is a record of a point in time and should not. Keeping them in one file meant every runbook edit rewrote the postmortem's history.
